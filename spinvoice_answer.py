...
class Invoice:
    ...
    def calculate_total(self, discount):
        ...
        for item in self.items:
            ...
            # in the original codebase, the discount is improperly applied to the total
            # here, the discount is applied to the price of the item, then tax is derived from the resultant value
